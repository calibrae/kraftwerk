...
integration tests, all green. Feature parity with Python virt-manager
across lifecycle, console (serial/VNC/SPICE), networking, storage,
hotplug, snapshots, live migration, templates, and cloud image import
— plus in-app auto-update.

Full feature matrix and per-area status: [docs/STATUS.md](docs/STATUS.md).
Multi-phase roadmap: [docs/ROADMAP.md](docs/ROADMAP.md). Full surface
inventory: [docs/CONFIG_ROADMAP.md](docs/CONFIG_ROADMAP.md).
